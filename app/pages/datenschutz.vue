    ...
    <div class="page-container page-space py-20">
      <div class="prose">
        ...
        <p>
          ...
          Ren&eacute; M&uuml;nnich, Hauptstra&szlig;e 68, D-02742 Friedersdorf
        ...
        <p>
          ...
          Endger&auml;t des Nutzers (z.&nbsp;B. f&uuml;r Device-Fingerprinting)
          im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit
          widerrufbar.
        </p>
        ...
        <h3>Heroicons (lokales Hosting)</h3>
        <p>
          Diese Seite nutzt zur einheitlichen Darstellung von Icons Heroicons.
          Heroicons sind lokal installiert. Eine Verbindung zu Servern von
          Heroicons findet dabei nicht statt.
        </p>
        <p>
          Weitere Informationen zu Heroicons finden Sie in der
          Datenschutzerkl&auml;rung f&uuml;r Heroicons unter:
          <a
            href="https://heroicons.com/privacy"
            target="_blank"
            rel="noopener noreferrer nofollow"
            >https://heroicons.com/privacy</a
          >.
        </p>
      </div>
    </div>
